...
class ScannerNfcDetailsPage extends StatefulWidget {
  ScannerNfcDetailsPage({super.key, required this.scannedTag});

  final String scannedTag;

  @override
  State<ScannerNfcDetailsPage> createState() => _ScannerNfcDetailsPageState();
}

class _ScannerNfcDetailsPageState extends State<ScannerNfcDetailsPage> {
  String placeholder = "\"\"";
